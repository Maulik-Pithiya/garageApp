  ...
  return (
    ...
    <div className="flex h-screen bg-gray-50 text-gray-800">
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-100">
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors md:flex hidden"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-100 shadow-sm">
          <button
            onClick={toggleSidebar}
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold shadow-sm">
              A
            </div>
          </div>
        </header>
...
// Stat card with color variations
